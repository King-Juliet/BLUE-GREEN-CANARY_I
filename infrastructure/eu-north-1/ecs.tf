...
# Green frontend ECS cluster and task definition for this region.
module "frontend_ecs" {
  source = "../modules/ecs"
...
# Green backend ECS cluster and task definition for this region.
module "backend_ecs" {
  source = "../modules/ecs"
...
# Green frontend ECS service receiving public web traffic in this region.
